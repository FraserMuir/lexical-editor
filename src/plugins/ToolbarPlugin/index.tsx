...
import { $getSelectionStyleValueForProperty, $isParentElementRTL, $patchStyleText, $selectAll, $wrapNodes } from "@lexical/selection";
...
export function InsertPollDialog({ activeEditor, onClose }: { activeEditor: LexicalEditor; onClose: () => void }): JSX.Element {
...
function BlockFormatDropDown({ editor, blockType }: { blockType: keyof typeof blockTypeToBlockName; editor: LexicalEditor }): JSX.Element {
...
function FontDropDown({ editor, value, style }: { editor: LexicalEditor; value: string; style: string }): JSX.Element {
