...
function setTargetLine(targetLineElem: HTMLElement, targetBlockElem: HTMLElement, mouseY: number, anchorElem: HTMLElement) {
  ...
  targetLineElem.style.top = `${lineTop - anchorTop - TARGET_LINE_HALF_HEIGHT}px`;
...
function useDraggableBlockMenu(editor: LexicalEditor, anchorElem: HTMLElement): JSX.Element {
